...
Portions copyright 2018 Marc Paquette""".format(VERSION)

HELP = """Scans a MadCap Flare project for adherence to your style rules 
then displays a report in your preferred web browser. It's like picking 
the lint off your sweater, only more fun.
