...
_HARDCODE_STYLES = ['b', 'u', 'i']

rule.Error(
    extensions = rule.TOPICS_AND_SNIPPETS,

    match = lambda n: n.name() in _HARDCODE_STYLES,

    test = lambda n: False,

    message = """Hard-coded formatting.  What do you mean? To fix, use semantic
    stylesheet classes instead."""
)
